...
import org.example.o2o.api.v1.dto.store.request.StoreListRequest;
...
import org.example.o2o.api.v1.dto.store.response.StoreListResponseDto.StoreListResponse;
...
public interface StoreDocsController {
	...
	org.example.o2o.common.dto.ApiResponse<StoreDetailSearchResponse> getStoreById(@PathVariable Long id);
