...
class OrderServiceV1Test {
	...
	void testSaveOrderSuccessful() {
		...
		OrderCreateResponseDto order = orderServiceV1.order(orderDto);
	...
	void testSaveOrderFail_orderPriceNotEquals() {
		...
		assertThatThrownBy(() -> orderServiceV1.order(orderDto))
	...
	void testSaveOrderFail_idNotExists() {
		...
		assertThatThrownBy(() -> orderServiceV1.order(orderDtoInvalidMemberId))
			.isInstanceOf(ApiException.class);
		...
		assertThatThrownBy(() -> orderServiceV1.order(orderDtoInvalidStoreId))
			.isInstanceOf(ApiException.class);
		...
		assertThatThrownBy(() -> orderServiceV1.order(orderDtoInvalidAddressId))
			.isInstanceOf(ApiException.class);
	}
}
