...
import org.example.o2o.api.v2.dto.menu.response.MenuResponseDto;
...
@SpringBootTest
@Transactional
public class FindMenuServiceV2Test {
	...
	void testFindMenusSuccessful() {
		...
		MenusResponseDto storeMenus = menuServiceV2.findStoreMenus(
			menu.getStore().getId(),
	...
	void testFindMenuDetailSuccessful() {
		...
		MenuDetailResponseDto menuDetail = menuServiceV2.findStoreMenuDetail(menu.getId());
	...
	void testFindMenuDetailFail() {
		assertThatThrownBy(() -> menuServiceV2.findStoreMenuDetail(99L))
