...
public class StoreServiceV1Test {
	...
	void testGetStoresSuccessful() {
		...
		StoreListSearchResponse responseDto = storeService.findStores(pageable);
	...
	void testGetStoreByIdSuccessful() {
		...
		StoreDetailResponse responseDto = storeService.findStoreById(store.getId());
	...
	void testDeleteStoreByIdSuccessful() {
		...
		assertThatThrownBy(() -> storeService.findStoreById(store.getId()))
